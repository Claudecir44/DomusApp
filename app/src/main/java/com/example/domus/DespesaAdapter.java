...
public class DespesaAdapter extends RecyclerView.Adapter<DespesaAdapter.DespesaViewHolder> {
    ...
    public DespesaAdapter(Context context, List<Despesa> lista, OnDespesaListener listener) {
    ...
    class DespesaViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Despesa despesa, int position) {
            ...
            btnEditar.setOnClickListener(v -> listener.onEditar(despesa, position));
            btnExcluir.setOnClickListener(v -> listener.onExcluir(despesa, position));
        }
