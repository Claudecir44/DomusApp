...
public class BDCondominioHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_FUNC_CARGO = "cargo";
    ...
    public boolean verificarCredenciaisAdmin(String usuario, String senha) {
        ...
        Cursor cursor = null;
        try {
            String hashSenha = gerarHashLocal(senha);
            if (hashSenha == null) {
    ...
    // ============================================================
    // MÉTODO LOCAL DE HASH (substitui SecurityUtils)
    // ============================================================
    private String gerarHashLocal(String input) {
        ...
        try {
            ...
            Log.e(TAG, "Erro ao gerar hash: " + e.getMessage());
            return null;
        }
    }
}